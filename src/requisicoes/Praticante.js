...
const salvarDadosPessoais = async (formularioDeDados, setDesabilitar, setDisplayModal, setTituloModal, setConteudoModal) => {
  if (camposPreenchidos(formularioDeDados)) {
    ...
    mensagemParaErro("Informe os dados pessoais do praticante!", setDisplayModal, setTituloModal, setConteudoModal);
  }
};

const salvar =  (formularioDeDados, endpoint, chaveLocalStorage, setDesabilitar, setDisplayModal, setTituloModal, setConteudoModal) => {
...
const buscarDadosPraticante = async (endpoint, setDados, idPraticante,setDisplayModal, setTituloModal, setConteudoModal) => {
  try {
    ...
    console.error(error);
   // mensagemParaErro("Erro ao buscar dados do praticante!", setDisplayModal, setTituloModal, setConteudoModal);
  }
}
