...
import {
  BUSCAR_AVALIACAO_FISIOTERAPEUTICA_DO_PRATICANTE_POR_ID_GET, BUSCAR_EQUILIBRIO_DINAMICO_DO_PRATICANTE_POR_ID_GET,
...
const EquilibrioDinamico = () => {
  ...
  useEffect(() => {
    ...
    verificarStatusDoFormularioDeCadastro(BUSCAR_EQUILIBRIO_DINAMICO_DO_PRATICANTE_POR_ID_GET, setFormularioDeDados, formularioDeDados, setDesabilitar)
          ...
          <CCardBody>
            <CContainer>
              ...
              <CButton color="danger" style={{color: "white"}} disabled={desabilitar} onClick={() => {
                salvar(formularioDeDados, SALVAR_EQUILIBRIO_DINAMICO_DO_PRATICANTE_POST, setDesabilitar, setDisplayModal, setTituloModal, setConteudoModal)
              }}>
                Salvar
              </CButton>
            </CContainer>
