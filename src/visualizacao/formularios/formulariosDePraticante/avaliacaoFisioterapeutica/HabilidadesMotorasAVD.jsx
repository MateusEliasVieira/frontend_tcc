...
const HabilidadesMotorasAVD = () => {
  ...
  useEffect(() => {
    ...
    verificarStatusDoFormularioDeCadastro(BUSCAR_HABILIDADES_MOTORAS_AVD_DO_PRATICANTE_POR_ID_GET, setFormularioDeDados, formularioDeDados, setDesabilitar)
          ...
          <CCardBody>
            <CContainer>
              ...
              <CButton color="danger" style={{color: "white"}} disabled={desabilitar} onClick={() => {
                salvar(formularioDeDados, SALVAR_HABILIDADES_MOTORAS_AVD_DO_PRATICANTE_POST, setDesabilitar, setDisplayModal, setTituloModal, setConteudoModal)
              }}>
                Salvar
              </CButton>
            </CContainer>
