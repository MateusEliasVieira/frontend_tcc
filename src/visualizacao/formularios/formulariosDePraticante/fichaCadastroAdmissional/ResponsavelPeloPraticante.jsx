...
const ResponsavelPeloPraticante = () => {
  ...
  useEffect(() => {
    ...
    verificarStatusDoFormularioDeCadastro(BUSCAR_RESPONSAVEL_DO_PRATICANTE_POR_ID_GET, setFormularioDeDados, formularioDeDados, setDesabilitar)
          ...
          <CCardBody>
            <CContainer>
              ...
              <CButton color="danger" style={{color: "white"}} disabled={desabilitar} onClick={() => {
                salvar(formularioDeDados, SALVAR_RESPONSAVEL_DO_PRATICANTE_POST, setDesabilitar, setDisplayModal, setTituloModal, setConteudoModal)
              }}>
                Salvar
              </CButton>
            </CContainer>
