      ...
      {idPraticante !== "" ?
        <CContainer style={{
          ...
          <CContainer ref={conteudoDocumento}>
            ...
            <ResponsavelPeloPraticanteRelatorio idUsuario={idPraticante}/>{espacar ? <>
              <br/><br/><br/><br/><br/><br/></> :
            <br/>}
            ...
            <EmPERelatorio idUsuario={idPraticante}/>{espacar ? <>
              <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/></> :
            <br/>}
            <strong className="titulos-relatorio-praticante">Plano Terapêutico Singular - PTS</strong>{espacar ? <br/> :
            <br/>}
