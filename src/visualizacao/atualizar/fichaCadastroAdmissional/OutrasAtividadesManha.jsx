...
const OutrasAtividadesManha = () => {
  ...
  useEffect(() => {
    ...
    verificarStatusCadastroParaAtualizacaoDosDemaisFormularios(BUSCAR_OUTRAS_ATIVIDADE_MANHA_DO_PRATICANTE_POR_ID_GET, setFormularioDeDados, setIdPraticante)
