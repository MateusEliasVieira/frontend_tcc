...
const OutrasAtividadesTarde = () => {
  ...
  useEffect(() => {
    ...
    verificarStatusCadastroParaAtualizacaoDosDemaisFormularios(BUSCAR_OUTRAS_ATIVIDADE_TARDE_DO_PRATICANTE_POR_ID_GET, setFormularioDeDados, setIdPraticante)
          ...
          <CCardBody>
            <CContainer>
              ...
              <CButton color="danger" style={{color: "white"}} onClick={() => {
                atualizar(formularioDeDados, ATUALIZAR_OUTRAS_ATIVIDADE_TARDE_DO_PRATICANTE_PUT, setDisplayModal, setTituloModal, setConteudoModal)
              }}>
                Atualizar
              </CButton>
            </CContainer>
