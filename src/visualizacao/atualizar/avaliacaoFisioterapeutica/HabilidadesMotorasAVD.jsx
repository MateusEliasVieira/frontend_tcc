...
const HabilidadesMotorasAVD = () => {
  ...
  useEffect(() => {
    ...
    verificarStatusCadastroParaAtualizacaoDosDemaisFormularios(BUSCAR_HABILIDADES_MOTORAS_AVD_DO_PRATICANTE_POR_ID_GET, setFormularioDeDados, setIdPraticante)
